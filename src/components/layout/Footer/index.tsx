...
const Footer = () => {
  return (
    <footer className="outer-wrapper footer-section">
      <article>
      ...
      <article className="footer-image-links">
        <a target="_blank" rel="noreferrer" href="https://www.thesportsdb.com/">
          <img src={images.sportdb} alt="sportdb link" />
        </a>
        <a target="_blank" rel="noreferrer" href="https://www.theaudiodb.com/">
